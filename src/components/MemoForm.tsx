...
export default function MemoForm({
  ...
  const { suggestedTags, isLoading, error, suggestTags, reset } = useSuggestTags()
  ...
  const handleSuggestTags = () => {
    void suggestTags(formData.title, formData.content)
  }
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  disabled={!canSuggestTags || isLoading}
                  title={
                    canSuggestTags
                      ? 'AI가 메모 내용을 분석해 태그를 추천합니다'
                      : '제목과 내용을 입력한 후 태그를 추천받을 수 있습니다'
                  }
